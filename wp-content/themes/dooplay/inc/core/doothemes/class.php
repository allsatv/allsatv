...
class Doothemes {
	...
	function license_menu(){
		...
		add_theme_page($strings['theme-license'], __d('Dooplay license'), 'manage_options', $this->theme_slug.'-license', array( $this, 'license_page'), 'dashicons-admin-network');
	}
	...
	function license_page(){
		...
		echo '<tr><td class="title">'.__d('User id').'</td><td class="apivalue" id="user_id"></td></tr>';
	...
	function get_api_response( $api_params ) {
		$response = wp_remote_get( $this->remote_api_url, array('timeout' => 15, 'sslverify' => false, 'body' => $api_params ) );
