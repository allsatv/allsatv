...
class DDbmoviesEnqueues extends DDbmoviesHelpers{
    ...
    public function Enqueues(){
        ...
        // All Scripts
        wp_enqueue_style('dbmovies-app', DBMOVIES_DBMVAPI.'/v2/assets/dbmovies.min.css', array(), DBMOVIES_VERSION);
        wp_enqueue_script('dbmovies-app', DBMOVIES_DBMVAPI.'/v2/assets/dbmovies.min.js', array('jquery'), DBMOVIES_VERSION);
